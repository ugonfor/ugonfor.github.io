(function() {
  ...
  function normalizePlayerName(value) {
    const cleaned = String(value || "").replace(/[\u0000-\u001f\u007f]/g, " ").replace(/[<>]/g, "").replace(/\s+/g, " ").trim().slice(0, 18);
    return cleaned || "플레이어";
  }
  ...
  const places = {
    ...
    florist: { x: 13, y: 16.5 },
    // 건물 남쪽 문 앞
    library: { x: 11.5, y: 30.5 },
    // 건물 남쪽 문 앞
    ksa_main: { x: 44.5, y: 11.5 },
    // 건물 남쪽 문 앞
    ksa_dorm: { x: 44.5, y: 16.5 }
    // 건물 남쪽 문 앞
  };
  const buildings = [
    ...
    { id: "houseA", x: 8, y: 35, w: 2, h: 2, z: 2, color: "#e8c9a6", roof: "#c4a073", label: "주택" },
    { id: "houseB", x: 50, y: 30, w: 2, h: 2, z: 2, color: "#d4b89a", roof: "#b09572", label: "주택" },
    { id: "houseC", x: 38, y: 40, w: 2, h: 2, z: 2, color: "#ceb798", roof: "#a89370", label: "주택" }
  ];
  const hotspots = [
  ...
  const props = [
    ...
    { type: "bench", x: 8, y: 9 },
    { type: "bench", x: 12, y: 9 },
    { type: "bench", x: 8, y: 11.5 },
    { type: "bench", x: 12, y: 11.5 },
    { type: "tree", x: 7.2, y: 7.5 },
    { type: "tree", x: 13.5, y: 7.8 },
    { type: "tree", x: 7, y: 12.8 },
    { type: "tree", x: 14, y: 13 },
    { type: "flower", x: 8.5, y: 8 },
    { type: "flower", x: 11.5, y: 8.2 },
    { type: "flower", x: 9, y: 12 },
    { type: "flower", x: 11, y: 12.2 },
    { type: "bush", x: 6.5, y: 10 },
    { type: "bush", x: 14.5, y: 10.5 },
    // 꽃집 (12,14) 주변
    { type: "flower", x: 11, y: 13.5 },
    { type: "flower", x: 11.5, y: 15.5 },
    { type: "flower", x: 14.5, y: 14.2 },
    { type: "flower", x: 14, y: 15.8 },
    { type: "flower", x: 13.5, y: 13.2 },
    { type: "bush", x: 11.2, y: 16.5 },
    // 카페/사무실
    { type: "tree", x: 28, y: 9 },
    { type: "tree", x: 39, y: 11 },
    { type: "bush", x: 33, y: 9.5 },
    { type: "bush", x: 37, y: 14.5 },
    { type: "flower", x: 29, y: 12.5 },
    { type: "lamp", x: 31, y: 14 },
    // KSA 캠퍼스
    { type: "tree", x: 40, y: 7 },
    { type: "tree", x: 48, y: 7.5 },
    { type: "tree", x: 40, y: 17 },
    { type: "tree", x: 48, y: 16.5 },
    { type: "bush", x: 41, y: 12 },
    { type: "bush", x: 47, y: 12.5 },
    { type: "bench", x: 41, y: 10 },
    { type: "bench", x: 46, y: 10 },
    { type: "lamp", x: 44, y: 11.5 },
    { type: "lamp", x: 44, y: 16.5 },
    { type: "fence", x: 41, y: 7 },
    { type: "fence", x: 42, y: 7 },
    { type: "fence", x: 47, y: 7 },
    { type: "fence", x: 48, y: 7 },
    { type: "flower", x: 43, y: 7.5 },
    { type: "flower", x: 45, y: 7.5 },
    { type: "signpost", x: 42, y: 18 },
    // 놀이터 (30,20)
    { type: "fence", x: 28, y: 18 },
    { type: "fence", x: 29, y: 18 },
    { type: "fence", x: 31, y: 18 },
    { type: "fence", x: 32, y: 18 },
    { type: "bench", x: 28, y: 22 },
    { type: "bench", x: 32, y: 22 },
    { type: "lamp", x: 28, y: 20 },
    { type: "lamp", x: 32, y: 20 },
    // 광장 (20,25)
    { type: "lamp", x: 18, y: 23.5 },
    { type: "lamp", x: 22, y: 23.5 },
    { type: "lamp", x: 18, y: 26.5 },
    { type: "lamp", x: 22, y: 26.5 },
    { type: "bench", x: 17, y: 24 },
    { type: "bench", x: 23, y: 24 },
    { type: "signpost", x: 21, y: 23.5 },
    { type: "bush", x: 17, y: 26 },
    { type: "bush", x: 23.5, y: 26 },
    // 빵집/도서관/시장 주변
    { type: "bush", x: 23, y: 26.5 },
    { type: "flower", x: 26.5, y: 27.5 },
    { type: "tree", x: 8, y: 27 },
    { type: "tree", x: 14, y: 29 },
    { type: "bench", x: 9, y: 30.5 },
    { type: "bush", x: 13.5, y: 28 },
    { type: "tree", x: 23, y: 33.5 },
    { type: "tree", x: 30, y: 30.5 },
    { type: "lamp", x: 27, y: 34 },
    { type: "bush", x: 24, y: 33 },
    // 주택A (8,35)
    { type: "fence", x: 7, y: 37.5 },
    { type: "fence", x: 8, y: 37.5 },
    { type: "fence", x: 9, y: 37.5 },
    { type: "fence", x: 10, y: 37.5 },
    { type: "flower", x: 7.5, y: 34.5 },
    { type: "flower", x: 10.5, y: 34.5 },
    { type: "tree", x: 6, y: 33 },
    { type: "bush", x: 11, y: 36 },
    // 주택B (50,30)
    { type: "fence", x: 49, y: 32.5 },
    { type: "fence", x: 50, y: 32.5 },
    { type: "fence", x: 51, y: 32.5 },
    { type: "fence", x: 52, y: 32.5 },
    { type: "flower", x: 49.5, y: 29.5 },
    { type: "flower", x: 52.5, y: 29.5 },
    { type: "tree", x: 53, y: 28 },
    { type: "bush", x: 48, y: 31 },
    // 주택C (38,40)
    { type: "fence", x: 37, y: 42.5 },
    { type: "fence", x: 38, y: 42.5 },
    { type: "fence", x: 39, y: 42.5 },
    { type: "fence", x: 40, y: 42.5 },
    { type: "flower", x: 37.5, y: 39.5 },
    { type: "flower", x: 40.5, y: 39.5 },
    { type: "tree", x: 36, y: 38 },
    { type: "bush", x: 41, y: 41 },
    // 도로 주변
    { type: "lamp", x: 15, y: 43.5 },
    { type: "lamp", x: 30, y: 43.5 },
    { type: "lamp", x: 50, y: 43.5 },
    { type: "lamp", x: 45, y: 20 },
    { type: "lamp", x: 45, y: 35 },
    { type: "signpost", x: 20, y: 43.5 },
    // 자연 소품
    { type: "tree", x: 18, y: 5 },
    { type: "tree", x: 25, y: 4.5 },
    { type: "tree", x: 35, y: 6 },
    { type: "tree", x: 32, y: 20 },
    { type: "tree", x: 38, y: 22 },
    { type: "tree", x: 15, y: 20 },
    ...
    { type: "rock", x: 16, y: 7 },
    { type: "rock", x: 7, y: 18 },
    { type: "rock", x: 7.5, y: 22 },
    { type: "rock", x: 6.5, y: 30 },
    { type: "tree", x: 7, y: 20 },
    // 확장 영역
    { type: "tree", x: 12, y: 50 },
    { type: "tree", x: 25, y: 52 },
  ...
  const discoveries = [
    ...
    { id: "rain_mushrooms", x: 18, y: 15, radius: 2, found: false, title: "비 오는 날의 버섯", desc: "비가 오자 길가에 형형색색 버섯이 자라났다.", condition: "rain", reward: "snack" },
    { id: "hidden_well", x: 35, y: 28, radius: 1.5, found: false, title: "숨겨진 우물", desc: "덤불 사이에서 오래된 우물을 발견했다.", condition: "always", reward: "gem" },
    { id: "sunset_view", x: 55, y: 6, radius: 2, found: false, title: "노을 전망대", desc: "언덕 위에서 아름다운 노을을 볼 수 있다.", condition: "evening", reward: "flower_red" },
    { id: "fog_figure", x: 12, y: 38, radius: 2, found: false, title: "안개 속 그림자", desc: "안개 속에서 희미한 형체를 발견했다...", condition: "fog", reward: "gem" },
    { id: "market_stash", x: 24, y: 34, radius: 1.5, found: false, title: "시장 뒷골목 비밀", desc: "시장 뒤에서 숨겨진 상자를 발견했다.", condition: "always", reward: "snack" },
    { id: "night_cats", x: 30, y: 38, radius: 2, found: false, title: "밤의 고양이들", desc: "밤에만 나타나는 고양이 무리를 발견했다!", condition: "night", reward: "snack" },
    { id: "flower_field", x: 8, y: 22, radius: 2, found: false, title: "비밀 꽃밭", desc: "수풀 사이에 숨겨진 꽃밭이 있었다.", condition: "always", reward: "flower_red" },
    { id: "storm_crystal", x: 20, y: 8, radius: 2, found: false, title: "폭풍의 수정", desc: "폭풍우 속에서 빛나는 수정을 발견했다!", condition: "storm", reward: "gem" },
    { id: "snow_angel", x: 28, y: 15, radius: 2, found: false, title: "눈 위의 천사", desc: "눈이 온 뒤 땅에 신비한 무늬가 생겼다.", condition: "snow", reward: "gem" },
    { id: "dawn_song", x: 22, y: 42, radius: 2, found: false, title: "새벽의 노래", desc: "이른 새벽, 어디선가 아름다운 노래가 들린다.", condition: "dawn", reward: "letter" },
    ...
    { id: "east_cabin", x: 70, y: 25, radius: 2, found: false, title: "동쪽 숲속 오두막", desc: "안개 속에서 오래된 오두막이 보인다...", condition: "fog", reward: "letter" },
    { id: "cat_village", x: 15, y: 55, radius: 2, found: false, title: "고양이 마을", desc: "밤이 되자 고양이들이 모여드는 비밀 장소!", condition: "night", reward: "snack" },
  ...
  const cardDefs = {
    ...
    card_friendship: { name: "우정의 증표", rarity: "epic", emoji: "🤝", effect: "관계도 +10%", effectKey: "relation", effectVal: 0.1 },
    ...
    card_gem_hunter: { name: "보석 사냥꾼", rarity: "epic", emoji: "💎", effect: "보석 발견 확률 증가", effectKey: "gemFind", effectVal: 0.2 },
...
${lines.join("\n")}`;
    ...
    function updateTagGame(dt) {
      ...
      if (remaining <= 0) {
        ...
        tagGame.cooldownUntil = nowMs() + 12e4;
      ...
      const dist2 = Math.hypot(player.x - targetNpc.x, player.y - targetNpc.y);
      if (dist2 < 1.5) {
        tagGame.active = false;
        tagGame.caught = true;
        tagGame.cooldownUntil = nowMs() + 12e4;
    ...
    function drawTagGameHud() {
      ...
      if (targetNpc) {
        const dist2 = Math.hypot(player.x - targetNpc.x, player.y - targetNpc.y);
        const distText = `거리: ${dist2.toFixed(1)}`;
    ...
    function updateWeather(dt) {
      ...
      if (now > weather.nextChangeAt) {
        ...
        weather.nextChangeAt = now + 18e4 + Math.random() * 3e5;
    ...
    function updateWeatherParticles(dt) {
      ...
      if (weather.current === "rain" || weather.current === "storm") {
        ...
        for (const p of weatherParticles.rain) {
          ...
          if (p.y > h) {
            ...
            weatherParticles.splashes.push({ x: p.x, y: h - Math.random() * 40, life: 0.3 });
          }
        }
      } else {
      ...
      for (let i = weatherParticles.leaves.length - 1; i >= 0; i--) {
        ...
        if (l.y > h + 20 || l.x < -40 || l.x > w + 40) {
          weatherParticles.leaves.splice(i, 1);
        }
      }
    }
    ...
    function updateFavorRequests() {
      ...
      for (const npc of npcs) {
        ...
        if (now < npc.lastRequestAt + 12e4) continue;
        if (dist(player, npc) > 20) continue;
        if (Math.random() > 8e-3) continue;
    ...
    function checkFavorCompletion(npc) {
      ...
      if (req.type === "visit_place") {
        if (req.targetPlace && dist(player, req.targetPlace) < 3) {
          completeFavor(npc, req);
          return true;
        }
    ...
    function tryCardDrop(trigger, context) {
      ...
      else if (trigger === "timed_event") chance = 0.3;
      else chance = 0.03;
      if (Math.random() > chance) return;
      const eligible = Object.entries(cardDefs).filter(([id, card2]) => {
        const rChance = card2.rarity === "legendary" ? 0.02 : card2.rarity === "epic" ? 0.12 : card2.rarity === "rare" ? 0.25 : 0.5;
    ...
    function buyItem(itemKey) {
      ...
      if (!shop) {
        addChat("System", "존재하지 않는 아이템입니다.");
        return false;
      }
      if (shop.stock <= 0) {
        addChat("System", "재고가 없습니다.");
        return false;
      }
      if (coins < shop.price) {
        addChat("System", `코인이 부족합니다. (보유: ${coins}코인, 필요: ${shop.price}코인)`);
        return false;
      }
      coins -= shop.price;
      shop.stock -= 1;
    ...
    const unlockedAchievements = /* @__PURE__ */ new Set();
    ...
    function startChallenge() {
      ...
      if (tmpl.id === "speed_delivery") {
        ...
        challenge.talkedNpcs = /* @__PURE__ */ new Set();
    ...
    function updateChallenge() {
      if (!challenge.active) {
        ...
        if (now > nextChallengeAt && questCount >= 5) {
          nextChallengeAt = now + 18e4 + Math.random() * 3e5;
    ...
    function countryCodeToFlag(code) {
      ...
      const flag = String.fromCodePoint(
        cc.charCodeAt(0) - 65 + 127462,
        cc.charCodeAt(1) - 65 + 127462
      );
      return normalizePlayerFlag(flag);
    }
    async function detectCountryFlag() {
      try {
        const res = await fetch("https://ipapi.co/country_code/", { signal: AbortSignal.timeout(3e3) });
        if (!res.ok) return "";
    ...
    async function initPlayerName() {
      ...
      if (!storedFlag) {
        ...
        if (detected) {
          storedFlag = detected;
          try {
            localStorage.setItem(PLAYER_FLAG_KEY, storedFlag);
          } catch {
          }
        }
      }
    ...
    async function getHumanVerificationToken(action = "npc_chat") {
      if (typeof window.PG_HUMAN_TOKEN_PROVIDER === "function") {
        const token2 = await window.PG_HUMAN_TOKEN_PROVIDER(action);
        return String(token2 || "").trim();
      }
    ...
    const removedNpcIds = /* @__PURE__ */ new Set();
    ...
    async function createSharedNpc(name, personality) {
      ...
      if (!res.ok) {
        ...
        throw new Error(data2.error || `Shared NPC API ${res.status}`);
      }
      const data = await res.json();
      return data.npc;
    }
    ...
    function loadMobileSheetState() {
      ...
      mobileSheetTab = loaded?.tab === "controls" || loaded?.tab === "info" || loaded?.tab === "log" || loaded?.tab === "chat" ? loaded.tab : "controls";
    }
    ...
    function addChat(speaker, text, source) {
      ...
      if (source === "remote" || source === "local-player") {
        addGlobalChat(speaker, text, source);
        return;
      }
      const targetNpcId = conversationFocusNpcId || (chatSession.npcId && performance.now() < chatSession.expiresAt ? chatSession.npcId : null);
      if (targetNpcId) {
        addNpcChat(targetNpcId, speaker, text);
      } else {
        addGlobalChat(speaker, text, source);
      }
    }
    ...
    function setChatSession(npcId, holdMs = 12e3) {
    ...
    function activeConversationNpc() {
      ...
      if (pinned && dist(player, pinned) <= CHAT_NEARBY_DISTANCE * 2) return pinned;
      const target = chatTargetNpc();
    ...
    function roadTile(x, y) {
      ...
      if (Math.abs(x - 45) <= 1 && y >= 10 && y <= 45) return true;
      if (Math.abs(y - 45) <= 1 && x >= 8 && x <= 55) return true;
      return false;
    }
    function waterTile(x, y) {
      if (y < 4 || y > world.height - 3) return false;
      const riverCenter = 4 + Math.sin(y * 0.34) * 1.2 + Math.sin(y * 0.12 + 0.5) * 0.6;
    ...
    function npcAmbientLine(npc) {
      ...
      if (mem.entries.length > 0 && Math.random() < 0.3) {
        ...
        if (giftEntries.length > 0) {
          const last2 = giftEntries[giftEntries.length - 1];
          memLines.push(`${last2.metadata.item ? "그때 받은 선물… 아직 간직하고 있어." : "선물 고마웠어."}`);
        }
    ...
    function maybeRunAutoConversation(now) {
      ...
      setChatSession(npc.id, 9e3);
      nextAutoConversationAt = now + 13e3 + Math.random() * 12e3;
      (async () => {
        const playerLine = await requestLlmPlayerLine(npc);
        upsertSpeechBubble("player", playerLine, 3e3);
    ...
    function updateAmbientSpeech(now) {
      ...
      if (now >= nextAmbientBubbleAt) {
        nextAmbientBubbleAt = now + 6800 + Math.random() * 11e3;
        ...
        if (pool.length) {
          ...
          upsertSpeechBubble(npc.id, line, 3400 + Math.random() * 2e3);
        }
      }
      if (autoWalk.enabled && now >= nextPlayerBubbleAt && !playerBubblePending) {
        nextPlayerBubbleAt = now + 12e3 + Math.random() * 14e3;
        playerBubblePending = true;
        const near = nearestNpc(2.4);
        requestLlmPlayerLine(near ? near.npc : null).then((line) => {
    ...
    function nearestNpc(maxDist) {
      const items = npcs.map((npc) => ({ npc, d: dist(player, npc) })).filter((item) => item.d <= maxDist).sort((a, b) => a.d - b.d);
    ...
    function chatTargetNpc() {
      ...
      if (pinned) {
        ...
        if (pd <= CHAT_NEARBY_DISTANCE * 2) return { npc: pinned, focused: true, near: false };
        conversationFocusNpcId = null;
      }
    ...
    function nearestHotspot(maxDist) {
      const items = hotspots.map((h) => ({ h, d: dist(player, h) })).filter((item) => item.d <= maxDist).sort((a, b) => a.d - b.d);
        ...
        make(fromNpc, targetNpc) {
          ...
          return {
            ...
            stages: [
              ...
              { visit: cluePlace, radius: 3, objective: `${cluePlaceName} 근처에서 단서를 찾으세요.`, autoText: `${cluePlaceName}에서 단서를 발견했습니다. 이 근처에서 활동하는 사람이 있는 것 같습니다.` },
    ...
    function completeDynamicQuest() {
      ...
      if (questType === "urgent" && startedAt > 0) {
        const elapsed = (nowMs() - startedAt) / 1e3;
        if (elapsed <= 60) {
    ...
    function generateDynamicQuest() {
      ...
      function applyQuest(q2, type, primaryNpc) {
        quest.title = q2.title;
        quest.stage = 0;
        quest.objective = q2.stages[0].objective;
        quest.done = false;
        quest.dynamic = true;
        quest.dynamicStages = q2.stages;
        quest.questType = type;
        quest.primaryNpcId = primaryNpc.id;
        quest.startedAt = nowMs();
        quest._stageCount = q2.stages.length;
        quest._onComplete = q2.onComplete || null;
        addChat("System", `새 퀘스트: ${q2.title}`);
        enrichQuestDialogue(type, primaryNpc, q2.stages);
      }
    }
    ...
    function handleHotspotInteraction() {
      ...
      if (hs.id === "minigameZone") {
        ...
        if (nowMs() < tagGame.cooldownUntil) {
          const wait = Math.ceil((tagGame.cooldownUntil - nowMs()) / 1e3);
    ...
    function interact() {
      ...
      if (near) {
        ...
        setChatSession(near.npc.id, 18e3);
        if (isMobileViewport()) {
          mobileChatOpen = true;
    ...
    function npcReply(npc, text) {
      ...
      if (topic === "positive") {
        ...
        return friendly ? "헤헤, 고마워! 너도 참 좋은 사람이야." : "고마워요. 당신의 행동이 이 동네 분위기를 조금씩 바꾸고 있어요.";
      }
      if (topic === "quest") {
        if (quest.done) return friendly ? "이미 다 해냈잖아! 대단해." : "이미 모두를 연결해줬어요. 훌륭했어요.";
        return friendly ? `지금 목표는 '${quest.objective}'야. 힘내!` : `현재 목표는 '${quest.objective}' 입니다.`;
      }
      if (topic === "world") {
        return friendly ? "이 세계는 루틴, 관계, 이벤트로 돌아가. 같이 돌아다녀 볼까?" : "이 세계는 루틴, 관계, 작은 이벤트로 움직여요. 계속 관찰해 보세요.";
      }
      if (topic === "people") {
        return friendly ? "여기 사람들, 시간대마다 달라져. 다음에 같이 찾아보자!" : "여기 사람들은 시간에 따라 달라져요. 시간대를 바꿔서 다시 말 걸어보세요.";
      }
    ...
    async function sendChatMessage(msg) {
      if (/^(선물|gift|줘|give)$/i.test(msg.trim())) {
        const target2 = chatTargetNpc();
        if (target2 && target2.near) {
          addChat("You", msg);
          giftItemToNpc(target2.npc);
        } else {
          addChat("You", msg);
      ...
      if (/^(술래잡기|tag)$/i.test(msg.trim())) {
        ...
        if (tagGame.active) {
          ...
          if (!candidates.length) {
            ...
            addChat(target2.name, "잡아봐~! 🏃💨");
            conversationFocusNpcId = null;
            if (isMobileViewport()) mobileChatOpen = false;
            startTagGame(target2);
          }
        }
        return;
      }
      ...
      if (/^(도전|challenge)$/i.test(msg.trim())) {
        if (challenge.active) {
          const remaining = Math.max(0, Math.ceil((challenge.endsAt - nowMs()) / 1e3));
      ...
      if (reply) {
        ...
        applyConversationEffect(npc, msg);
    ...
    function updateAmbientEvents() {
      ...
      if (!timedEvent.active && evNow > timedEvent.nextCheckAt) {
        timedEvent.nextCheckAt = evNow + 6e4 + Math.random() * 12e4;
        ...
        generate([npcA, npcB]) {
          return [
            ...
            { type: "choice", text: "누구의 편을 들겠습니까?", options: [
              { label: `${npcA.name} 편`, effect() {
                adjustNpcRelation(npcA.id, npcB.id, -5);
                const rk = relationKeyForNpc(npcA.id);
                if (rk) adjustRelation(rk, 5);
              } },
              { label: `${npcB.name} 편`, effect() {
                adjustNpcRelation(npcA.id, npcB.id, -5);
                const rk = relationKeyForNpc(npcB.id);
                if (rk) adjustRelation(rk, 5);
              } },
              { label: "중재하기", effect() {
                adjustNpcRelation(npcA.id, npcB.id, 15);
              } }
            ], objective: "선택하세요." },
      ...
      },
      {
        ...
        generate(npc) {
          ...
          return [
            ...
            { type: "talk", npcId: npc.id, text: `${admirer.name}이(가)? 정말? 고마운 마음이 전해졌어.`, objective: `${npc.name}에게 알려주세요.`, onComplete() {
              adjustNpcRelation(npc.id, admirer.id, 15);
            } }
          ];
        }
      },
      {
        ...
        generate(npc) {
          ...
          return [
            ...
            { type: "talk", npcId: npc.id, text: "찾아줘서 정말 고마워! 이건 나에게 정말 소중한 거야.", objective: `${npc.name}에게 돌려주세요.`, onComplete() {
              npc.favorPoints += 20;
            } }
          ];
        }
    ...
    function handleStoryArcInteraction(npc, msg) {
      ...
      if (ch.type === "choice") {
        ...
        if (num >= 1 && num <= ch.options.length) {
          ...
          if (typeof opt.effect === "function") try {
            opt.effect();
          } catch {
          }
          advanceStoryArc();
    ...
    function updateNpcSocialInteractions() {
      ...
      nextNpcSocialAt = now + 8e3 + Math.random() * 12e3;
      for (const a of npcs) {
        for (const b of npcs) {
          if (a.id >= b.id) continue;
          ...
          if (Math.random() < 0.15 && dist(player, a) < 8) {
            const lines = rel >= 65 ? [`${b.name}이랑은 잘 지내고 있어.`, `${b.name}, 요즘 좋은 친구야.`] : rel < 35 ? [`${b.name}이랑은 좀 서먹해...`, `${b.name}이랑 사이가 좀 그래.`] : [`${b.name}이랑은 그냥 평범한 사이야.`];
    ...
    function saveState() {
      const state = {
        ...
        relations,
        quest,
        npcs: npcs.filter((n) => !n.id.startsWith("shared_") && !n.id.startsWith("custom_")).map((n) => ({
          id: n.id,
          x: n.x,
          y: n.y,
          talkCooldown: n.talkCooldown,
          favorLevel: n.favorLevel,
          favorPoints: n.favorPoints,
          memory: n.memory
        })),
        inventory: { ...inventory },
    ...
    function loadState() {
      ...
      try {
        ...
        if (state.world) {
          ...
          world.zoom = clamp(Math.max(state.world.zoom ?? DEFAULT_ZOOM, 2), ZOOM_MIN, ZOOM_MAX);
    ...
    function updatePlayer(dt) {
      ...
      if (manualDx || manualDy) {
        ...
        const tx2 = player.moveTarget.x - player.x;
        const ty2 = player.moveTarget.y - player.y;
        const td = Math.hypot(tx2, ty2);
        if (td <= 0.08) {
          player.moveTarget = null;
        } else {
          dx = tx2 / td;
    ...
    function updateNpcs(dt) {
      ...
      for (const npc of npcs) {
        ...
        if (!npc.roamTarget || Math.random() < 3e-3) {
    ...
    function getGroundSprite(kind, variant = "a") {
      return spriteCanvas(`ground:${kind}:${variant}`, 32, 32, (c, w, h) => {
        const base = kind === "water" ? variant === "b" ? palette.waterB : palette.waterA : kind === "road" ? variant === "b" ? palette.roadB : palette.roadA : variant === "c" ? palette.grassC : variant === "b" ? palette.grassB : palette.grassA;
        c.fillStyle = base;
        c.fillRect(0, 0, w, h);
        if (kind === "water") {
    ...
    function drawBuilding(b) {
      ...
      if (b.id === "bakery") {
        ...
        for (let i = 0; i < 4; i++) {
          ...
          ctx.lineTo(
            (pA.x + pD.x) * 0.5 + ((pB.x + pC.x) * 0.5 - (pA.x + pD.x) * 0.5) * t,
      ...
      if (b.id === "cafe") {
        ...
        ctx.beginPath();
        ctx.roundRect(bx - 5, by - 3, 10, 6, 3);
        ctx.fill();
        ...
        ctx.beginPath();
        ctx.roundRect(bx - 5, by - 4, 10, 8, 1);
        ctx.fill();
        ...
        ctx.fill();
        ctx.beginPath();
        ctx.roundRect(hx - 3, hy - 1, 6, 5, 0.5);
        ctx.fill();
      } else {
        const bx = signCx - signW * 0.33;
        const by = signCy - 1.8;
    ...
    function getPropSprite(type, variant = "a") {
      return spriteCanvas(`prop:${type}:${variant}`, 110, 130, (c, w, h) => {
        ...
        if (type === "bench") {
          ...
          c.fillStyle = grad;
          c.beginPath();
          c.roundRect(cx - 16, baseY - 6, 32, 5, 2);
          c.fill();
          c.beginPath();
          c.roundRect(cx - 16, baseY - 14, 32, 3, 2);
          c.fill();
          c.fillStyle = "#8a6840";
        ...
        if (type === "signpost") {
          ...
          c.fillStyle = bg;
          c.beginPath();
          c.roundRect(cx - 12, baseY - 26, 24, 10, 2);
          c.fill();
        ...
        if (type === "fountain") {
          ...
          c.fillStyle = "#d0d0d0";
          c.beginPath();
          c.roundRect(cx - 3, baseY - 24, 6, 24, 2);
          c.fill();
          c.fillStyle = "#a8d4f0";
          c.beginPath();
    ...
    function drawGround() {
      ...
      if (isNight) {
        ...
        if (weather.current === "clear" || weather.current === "cloudy") {
          ...
          for (let i = 0; i < 25; i++) {
            ...
            const twinkle = Math.sin(nowMs() * 2e-3 + i * 2.1) * 0.3 + 0.5;
      ...
      for (let y = 5; y < world.height - 3; y += 1) {
        const cx = 4 + Math.sin(y * 0.34) * 1.2 + Math.sin(y * 0.12 + 0.5) * 0.6;
    ...
    function drawDiscoverySparkles() {
      ...
      for (const d of discoveries) {
        ...
        for (let i = 0; i < sparkleCount; i++) {
          const angle = (now * 1e-3 + i * Math.PI * 2 / sparkleCount) % (Math.PI * 2);
          const r = 8 + Math.sin(now * 3e-3 + i) * 4;
          const sx = p.x + Math.cos(angle) * r * world.zoom;
          const sy = p.y + Math.sin(angle) * r * world.zoom * 0.5 - 10;
          const a = 0.3 + Math.sin(now * 5e-3 + i * 1.5) * 0.2;
    ...
    function drawWorld() {
      ...
      for (const gi of groundItems) {
        ...
        const info = itemTypes[gi.type];
        const bobY = Math.sin(now * 3e-3 + gi.x * 2) * 3;
      ...
      for (const npc of npcs) {
        const mp2 = project(npc.x, npc.y, 0);
        const msz = Math.max(14, world.zoom * 4.5);
        if (tagGame.active && npc.id === tagGame.targetNpcId) {
          const bob = Math.sin(now * 8e-3) * 4;
          ctx.font = `${msz * 1.4}px sans-serif`;
          ctx.fillText("🏃💨", mp2.x - msz * 0.6, mp2.y - world.zoom * 34 + bob);
        } else if (npc.activeRequest) {
          const bob = Math.sin(now * 5e-3) * 3;
          ctx.font = `${msz * 1.3}px sans-serif`;
          ctx.fillText("❗", mp2.x - msz * 0.4, mp2.y - world.zoom * 32 + bob);
          ...
          ctx.fillText(moodEmoji, mp2.x + 12, mp2.y - world.zoom * 28);
        }
        if (npc.favorLevel > 0) {
          const hearts = "♥".repeat(Math.min(npc.favorLevel, 4));
          ctx.font = `${Math.max(10, world.zoom * 3)}px sans-serif`;
          ctx.fillStyle = "#ff6b8a";
          ctx.fillText(hearts, mp2.x - npc.favorLevel * 4, mp2.y - world.zoom * 22);
    ...
    function drawSpeechBubbles() {
      ...
      for (let i = speechBubbles.length - 1; i >= 0; i -= 1) {
        ...
        const remain = (bubble.until - now) / 1e3;
    ...
    function drawTimedEventHud() {
      ...
      const by = 36;
      const urgency = remaining < 3e4 ? 0.9 : 0.75;
    ...
    function updateUI() {
      ...
      const npcNear = target && target.near;
      const mpChat = mp.enabled && !npcNear;
      npcNear ? target.npc.id : mpChat ? "__mp__" : null;
      if (chatTargetEl) {
        ...
        if (prevLabel !== newLabel) {
          chatTargetEl.textContent = newLabel;
          renderCurrentChat();
        }
      }
      ...
      (ev) => {
        ...
        if (ev.touches.length === 1 && inputState.touchPanActive) {
          ...
          if (inputState.pinchDist > 0) {
            const delta = (distNow - inputState.pinchDist) * 25e-4;
            world.zoom = clamp(world.zoom + delta, ZOOM_MIN, ZOOM_MAX);
          }
    ...
    syncSharedNpcs();
    if (WORLD_NPC_API_URL) {
      window.setInterval(syncSharedNpcs, 18e3);
    }
    resizeCanvasToDisplaySize();
      ...
      try {
        ...
        mp.messagesRef.orderByChild("ts").startAt(Date.now()).on("child_added", (snap) => {
          ...
          if (d.sessionId && mp.remotePlayers[d.sessionId]) {
            upsertSpeechBubble("remote_" + d.sessionId, text, 4e3);
          }
        });
    ...
    function mpSendMessage(text) {
      ...
      upsertSpeechBubble("player", safeText, 4e3);
    }

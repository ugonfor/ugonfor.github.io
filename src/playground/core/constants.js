...
export const npcPersonas = {
  heo: { age: "npc_age_20s", gender: "npc_gender_male", personality: "npc_personality_heo", quirk: "npc_quirk_heo" },
  kim: { age: "npc_age_20s", gender: "npc_gender_male", personality: "npc_personality_kim", quirk: "npc_quirk_kim" },
  choi: { age: "npc_age_20s", gender: "npc_gender_female", personality: "npc_personality_choi", quirk: "npc_quirk_choi" },
  jung: { age: "npc_age_20s", gender: "npc_gender_male", personality: "npc_personality_jung", quirk: "npc_quirk_jung" },
  seo: { age: "npc_age_20s", gender: "npc_gender_male", personality: "npc_personality_seo", quirk: "npc_quirk_seo" },
  lee: { age: "npc_age_20s", gender: "npc_gender_female", personality: "npc_personality_lee", quirk: "npc_quirk_lee" },
  park: { age: "npc_age_20s", gender: "npc_gender_male", personality: "npc_personality_park", quirk: "npc_quirk_park" },
  jang: { age: "npc_age_20s", gender: "npc_gender_male", personality: "npc_personality_jang", quirk: "npc_quirk_jang" },
  yoo: { age: "npc_age_20s", gender: "npc_gender_male", personality: "npc_personality_yoo", quirk: "npc_quirk_yoo" },
  guide: { age: "npc_age_20s", gender: "npc_gender_female", personality: "npc_personality_guide", isDocent: true, quirk: "npc_quirk_guide" },
  baker: { age: "npc_age_30s", gender: "npc_gender_female", personality: "npc_personality_baker", quirk: "npc_quirk_baker" },
  floristNpc: { age: "npc_age_20s", gender: "npc_gender_female", personality: "npc_personality_florist", quirk: "npc_quirk_floristNpc" },
  librarian: { age: "npc_age_30s", gender: "npc_gender_male", personality: "npc_personality_librarian", quirk: "npc_quirk_librarian" },
  residentA: { age: "npc_age_30s", gender: "npc_gender_male", personality: "npc_personality_residentA", quirk: "npc_quirk_residentA" },
  residentB: { age: "npc_age_20s", gender: "npc_gender_female", personality: "npc_personality_residentB", quirk: "npc_quirk_residentB" },
  residentC: { age: "npc_age_30s", gender: "npc_gender_male", personality: "npc_personality_residentC", quirk: "npc_quirk_residentC" },
  barista: { age: "npc_age_20s", gender: "npc_gender_female", personality: "npc_personality_barista", quirk: "npc_quirk_barista" },
  florist_owner: { age: "npc_age_20s", gender: "npc_gender_female", personality: "npc_personality_florist_owner", quirk: "npc_quirk_florist" },
  chef: { age: "npc_age_30s", gender: "npc_gender_male", personality: "npc_personality_chef", quirk: "npc_quirk_chef" },
  officer: { age: "npc_age_30s", gender: "npc_gender_male", personality: "npc_personality_officer", quirk: "npc_quirk_officer" },
  athlete: { age: "npc_age_20s", gender: "npc_gender_male", personality: "npc_personality_athlete", quirk: "npc_quirk_athlete" },
  doctor: { age: "npc_age_40s", gender: "npc_gender_female", personality: "npc_personality_doctor", quirk: "npc_quirk_doctor" },
  student_a: { age: "npc_age_teens", gender: "npc_gender_male", personality: "npc_personality_student_a", quirk: "npc_quirk_student_a" },
  student_b: { age: "npc_age_teens", gender: "npc_gender_female", personality: "npc_personality_student_b", quirk: "npc_quirk_student_b" },
  grandpa: { age: "npc_age_60s", gender: "npc_gender_male", personality: "npc_personality_grandpa", quirk: "npc_quirk_grandpa" },
};

...
function buildPromptKo(payload) {
  ...
  return [
    ...
    "",
    "후속 선택지:",
    "- 매 답변 끝에 플레이어가 다음에 할 수 있는 말 3가지를 태그로 붙이세요.",
    "- 형식: [선택지:옵션1|옵션2|옵션3]",
    "- 예시: '카페가 참 좋아! [선택지:어떤 메뉴가 맛있어?|같이 가자!|다음에 보자]'",
    "- 선택지는 대화 흐름에 자연스러운 후속 질문/반응이어야 합니다.",
    "- 마지막 선택지는 대화를 끝낼 수 있는 것으로 (예: '다음에 보자', '고마워')",
    "",
    "대화 마무리:",
...
function buildPromptEn(payload) {
  ...
  return [
    ...
    "",
    "Follow-up choices:",
    "- At the end of every reply, add 3 things the player could say next as a tag.",
    "- Format: [선택지:option1|option2|option3]",
    "- Example: 'The cafe is great! [선택지:What's good here?|Let's go together!|See you later]'",
    "- Choices should be natural follow-ups to the conversation flow.",
    "- The last choice should be a way to end the conversation (e.g. 'See you later', 'Thanks')",
    "",
